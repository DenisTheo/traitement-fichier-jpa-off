...
{
    @Override
    public List<Product> getProductsByCategory(String category, String allergenToExclude, String ingredientToExclude, int limit)
    {
        ...
        return entities.stream().map(ServiceLoader.provideProductMapper()).toList();
    }
